...
export const Card = ({ item }) => {
    ...
    const { id, title, price, category, images,rate } = item;
    ...
    return (
        <div className='fondo2 cursor-pointer h-60 w-full max-w-[350px] pb-4 rounded-lg relative border'>
            <figure
                className='relative mb-2 w-full h-2/3'
            ...
            >
                ...
                <img src={images[0]} alt={`image ${title}`} className='w-full h-full object-cover object-center rounded-lg' />
            </figure>
